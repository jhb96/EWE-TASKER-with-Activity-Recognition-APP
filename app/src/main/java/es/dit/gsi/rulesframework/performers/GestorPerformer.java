...
*/
    public void show (JSONObject params){
        /*
        String url = "";
        String title="";
        String description="";
        ...
        */
        ...
        try {
        notificationIntent.putExtra("url",params.getString("CMSURL"));
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        builder.setSmallIcon(R.mipmap.logo)
                ...
                .setContentTitle(params.getString("ContentID"))
                .setContentText(params.getString("ContentDescription"))
